var Requisitos = Vue.component('Requisitos', {
    ...
    methods: {
        ...
        addPDF: function () {
            ...
            this.fileUploadFormData.append('cat_Requirements_PDF', JSON.stringify({
                Requirements_PDF_Name: this.Requirements_PDF_Name
            }));
        ...
        editPDF: function (index) {
            ...
            this.fileUploadFormData.append('cat_Requirements_PDF', JSON.stringify({
                Requirements_PDF_Id: this.PDFs[index].Requirements_PDF_Id,
                Requirements_PDF_Name: this.PDFs[index].Requirements_PDF_Name
            }));
        ...
        deletePDF: function (Requirements_PDF_Id) {
            showLoader();

            this.$http.post(APIUrl() + 'RequirementsPDF/DeletePDF', {
        ...
        onFileChange: function (e, index) {
            ...
            if (index !== undefined) {
                this.PDFs[index].Requirements_PDF_Path = URL.createObjectURL(file);
            }
        },
        clearUI: function () {
            this.fileUploadFormData = new FormData();
            this.Requirements_PDF_Name = '';
                    ...
                    <div>
                        ...
                        <div class="form-group col-md-6 col-md-offset-3">
                            <div class="form-group">
                                ...
                                <a class="text-right f-right" v-bind:href="pdf.Requirements_PDF_Path" target="_blank">&nbsp;Ver&nbsp;<i class="far fa-eye"></i></a>
                                <input required type="text" v-model="pdf.Requirements_PDF_Name" class="form-control">
                            </div>
                        ...
                        <div class="form-group col-md-6 col-md-offset-3 text-center">
                            ...
                            <button v-on:click="deletePDF(pdf.Requirements_PDF_Id)" class="btn btn-danger">Eliminar</button>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <form v-on:submit.prevent="addPDF">
                        <div>
                            ...
                            <div class="form-group col-md-6 col-md-offset-3">
                                <div class="form-group">
                                    <label for="Requirements_PDF_Name">Nombre del archivo:</label>
                                    <input required type="text" v-model="Requirements_PDF_Name" id="Requirements_PDF_Name" class="form-control">
                                </div>
